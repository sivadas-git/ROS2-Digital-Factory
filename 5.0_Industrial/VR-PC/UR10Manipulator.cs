...
public class UR10Manipulator : MonoBehaviour
{
    ...
    // Public offsets (tune these in the Inspector)
    ...
    void Update()
    {
       ...
       float sign1 = invertJoint1 ? -1f : 1f;
        ...
        // Convert from radians to degrees and apply offsets
        ...
        // Apply joint rotations (assuming rotation along local Y axis; adjust if needed)
